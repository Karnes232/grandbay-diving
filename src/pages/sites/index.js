    ...
    <Layout>
      ...
      <div className="max-w-6xl my-5 xl:my-14 flex flex-col justify-center items-center lg:flex-row mx-5 lg:mx-auto">
        <TextComponent
          ...
          paragraph="Punta Cana is the underwater jewel of the Dominican Republic. When you are diving with us, we take you to the best dive sites of the region, a paradise for <a href='/shark-dive-punta-cana'>shark lovers</a>, wreck enthusiasts, turtles and rays galore! The healthy reefs around this side of the islands are thriving with marvelous creatures and colorful corals. Shallow reefs here receive sunlight all year round and have the perfect conditions for hard corals to grow beautiful and vigorous: we can see brain corals, labyrinth corals, whip corals, fan corals, acroporas, porites, millepora and pillar corals."
        />
