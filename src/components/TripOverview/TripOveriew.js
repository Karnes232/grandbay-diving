  ...
  return (
    <div className="my-5">
      ...
      <div className="flex flex-col justify-center items-center mb-2">
        ...
        <p className="my-1 text-center text-sm xl:text-lg">
          Price: ${trip.overview.price} per person
        </p>
        <p className="my-1 text-center text-sm xl:text-lg">(2 tank dive)</p>
        {trip.overview.companion && (
          <>
            <p className="my-1 text-center text-sm xl:text-lg">
              Price: ${trip.overview.companion} per person
            </p>
            <p className="my-1 text-center text-sm xl:text-lg">(companion)</p>{" "}
          </>
        )}
        <p className="my-1 text-center text-sm xl:text-lg">
