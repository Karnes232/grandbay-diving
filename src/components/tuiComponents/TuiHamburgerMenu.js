              ...
              >
                <>
                  <div className="py-1">
                    <Menu.Item>
                      {({ active }) => (
                        <Link to="/tui/discover" className="no-underline">
                          <button
                            className={`${
                              active
                    ...
                    <Menu.Item>
                      {({ active }) => (
                        <Link to="/tui/scubadiver" className="no-underline">
                          <button
                            className={`${
                              active
                                ? "bg-gray-100 text-gray-900"
                    ...
                    <Menu.Item>
                      {({ active }) => (
                        <Link to="/tui/openwater" className="no-underline">
                          <button
                            className={`${
                              active
                                ? "bg-gray-100 text-gray-900"
                    ...
                    <Menu.Item>
                      {({ active }) => (
                        <Link to="/tui/advanced" className="no-underline">
                          <button
                            className={`${
                              active
                                ? "bg-gray-100 text-gray-900"
                    ...
                    <Menu.Item>
                      {({ active }) => (
                        <Link to="/tui/sites" className="no-underline">
                          <button
                            className={`${
                              active
                                ? "bg-gray-100 text-gray-900"
                    ...
                    <Menu.Item>
                      {({ active }) => (
                        <Link to="/tui/catalina" className="no-underline">
                          <button
                            className={`${
                              active
                                ? "bg-gray-100 text-gray-900"
                    ...
                    <Menu.Item>
                      {({ active }) => (
                        <Link to="/tui/bayahibe" className="no-underline">
                          <button
                            className={`${
                              active
                                ? "bg-gray-100 text-gray-900"
