...
export const trips = [
  ...
  },
  {
    ...
    paragraph2:
      "Our diving excursion to Saona Island is very personalized as we only do it with private groups with a minimum of 4 people. That way we are able to provide the best service possible. The excursion is possible any day as long as the conditions are permitting. We will leave From the Punta Cana area at 8:30 am, (since it is private you don't have to wait for anyone else). It will take approximately 40 minutes until we reach Bayahibe where we will embark for our journey.",
    paragraph3:
